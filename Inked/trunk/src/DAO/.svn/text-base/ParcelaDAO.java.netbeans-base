...
public class ParcelaDAO {
    ...
    public List<Parcela> ListarParcela() throws SQLException {
        String sql = "select * from parcelas where par_datapgto >= current_date order by par_codigo";
    ...
    public List<Parcela> ListarDataDesejada(java.util.Date data) throws SQLException {
        String sql = "select * from parcelas where par_datapgto = ? order by par_codigo";
        List<Parcela> parcelas = new ArrayList<>();
        try {
            PreparedStatement pstmt = conn.prepareStatement(sql);
