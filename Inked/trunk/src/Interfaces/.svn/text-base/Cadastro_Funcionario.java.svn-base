...
public class Cadastro_Funcionario extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jBCadastrar, jBEditar, jBExcluir, jBLimpar, jBPesquisar});
    ...
    private void tabelaMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelaMouseClicked
        ...
        jTCPF.setText(tatuadores.get(tabela.getSelectedRow()).getCpf());
    ...
    private void jBExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBExcluirActionPerformed
        ...
        if (pergunta == 0) {//clicou em sim  
            try {
                FuncionarioDAO dao = new FuncionarioDAO();
                dao.remover(tatuadores.get(tabela.getSelectedRow()).getId());
            } catch (SQLException ex) {
                JOptionPane.showMessageDialog(null, "Erro:\n" + ex);
            }
