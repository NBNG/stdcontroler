...
public class Listagem_Sessao extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jDCDesejada.addPropertyChangeListener(new java.beans.PropertyChangeListener() {
            public void propertyChange(java.beans.PropertyChangeEvent evt) {
                jDCDesejadaPropertyChange(evt);
            }
        });
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jDCDesejada, jDCDesejadaTat});
    ...
    private void jDCDesejadaPropertyChange(java.beans.PropertyChangeEvent evt) {//GEN-FIRST:event_jDCDesejadaPropertyChange
        if (jRBDesejado.isSelected()) {
            jRBAtual.setSelected(false);
            jRBCliente.setSelected(false);
            jRBTatuador.setSelected(false);
    ...
    }//GEN-LAST:event_jDCDesejadaPropertyChange
